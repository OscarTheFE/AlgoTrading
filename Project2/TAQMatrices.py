...
class TAQMatrices(object):
    ...
    # if all the top 5 quotes are np.nan, it will return np.nan as well
    ...
    def get_arrival_price(self, date):
        ...
        arrival_prices = arrival_prices.fillna(method="bfill")
    ...
    def get_terminal_price(self, date):
        ...
        terminal_prices = terminal_prices.fillna(method="ffill")
