...
class TAQProcess(object):
    ...
    def traverse_ticker_trades(self,ticker):
        ...
        trade_dir = os.path.join(os.getcwd(), "./data/trades_test")
...
if __name__ == "__main__":
    ...
    # print(vwap_330_matrix)
    # print(vwap_400_matrix)
    # print(imbalance_share_matrix)
    # print(daily_volume_sum_matrix)
    # print(arrival_price_matrix)
    # print(ret_std_matrix)
